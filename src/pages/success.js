    ...
    <div className="h-screen overflow-y-scroll bg-gray-100 scrollbar-hide">
      ...
      <main className="mx-auto mt-5 w-[90vw] max-w-[1000px]">
        <div className="flex flex-col space-y-5 bg-white p-5">
          ...
          <button className="w-full rounded-sm border border-yellow-300 bg-gradient-to-b from-yellow-200 to-yellow-400 p-1 text-[13px] focus:outline-none focus:ring-1 focus:ring-yellow-500">
            Go to my orders
          </button>
        </div>
      </main>
